defmodule OriginsSdk.Feedback.CreateFeedback do
  @moduledoc """
  Input + metadata types for `create_feedback`. Generated — do not edit by hand.
  """

  defmodule Input do
    @moduledoc "Required arguments for `create_feedback`."
