defmodule OriginsSdk.Identity.UpdateOriginAsset do
  @moduledoc """
  Input + metadata types for `update_origin_asset`. Generated — do not edit by hand.
  """

  defmodule Input do
    @moduledoc "Required arguments for `update_origin_asset`."
