defmodule OriginsSdk.Identity.UpdateSoulConfig do
  @moduledoc """
  Input + metadata types for `update_soul_config`. Generated — do not edit by hand.
  """

  defmodule Input do
    @moduledoc "Required arguments for `update_soul_config`."
