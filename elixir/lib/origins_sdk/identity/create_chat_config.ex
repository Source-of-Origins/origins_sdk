defmodule OriginsSdk.Identity.CreateChatConfig do
  @moduledoc """
  Input + metadata types for `create_chat_config`. Generated — do not edit by hand.
  """

  defmodule Input do
    @moduledoc "Required arguments for `create_chat_config`."
