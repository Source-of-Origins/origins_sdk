defmodule OriginsSdk.Identity.UpdateOriginEntityProfileConfig do
  ...
  defmodule Input do
    ...
    @enforce_keys []
    defstruct [:appearance_config, :is_featured, :is_public, :public_profile_config]

    @doc false
    def to_json(%__MODULE__{} = input) do
      %{"appearance_config" => input.appearance_config, "is_featured" => input.is_featured, "is_public" => input.is_public, "public_profile_config" => input.public_profile_config}
    end
  end
