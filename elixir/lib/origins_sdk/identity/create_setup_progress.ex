defmodule OriginsSdk.Identity.CreateSetupProgress do
  @moduledoc """
  Input + metadata types for `create_setup_progress`. Generated — do not edit by hand.
  """

  defmodule Input do
    @moduledoc "Required arguments for `create_setup_progress`."
