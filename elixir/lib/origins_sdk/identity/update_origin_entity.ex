defmodule OriginsSdk.Identity.UpdateOriginEntity do
  @moduledoc """
  Input + metadata types for `update_origin_entity`. Generated — do not edit by hand.
  """

  defmodule Input do
    @moduledoc "Required arguments for `update_origin_entity`."
