defmodule OriginsSdk.Apps.AssessmentResponse do
  ...
  @primitive_fields ~w(answers app_id completed_at created_at current_node email graph_snapshot_edges graph_snapshot_nodes id path_history updated_at user_id)a
