defmodule OriginsSdk.Agent.UpdateConversation do
  @moduledoc """
  Input + metadata types for `update_conversation`. Generated — do not edit by hand.
  """

  defmodule Input do
    @moduledoc "Required arguments for `update_conversation`."
