defmodule OriginsSdk.ExpertPages.UpdateExpertPage do
  @moduledoc """
  Input + metadata types for `update_expert_page`. Generated — do not edit by hand.
  """

  defmodule Input do
    @moduledoc "Required arguments for `update_expert_page`."
