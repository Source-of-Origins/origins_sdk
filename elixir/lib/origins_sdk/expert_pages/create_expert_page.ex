defmodule OriginsSdk.ExpertPages.CreateExpertPage do
  @moduledoc """
  Input + metadata types for `create_expert_page`. Generated — do not edit by hand.
  """

  defmodule Input do
    @moduledoc "Required arguments for `create_expert_page`."
