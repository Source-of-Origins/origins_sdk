defmodule OriginsSdk.Homepage.UpdateHomepageCard do
  @moduledoc """
  Input + metadata types for `update_homepage_card`. Generated — do not edit by hand.
  """

  defmodule Input do
    @moduledoc "Required arguments for `update_homepage_card`."
