defmodule OriginsSdk.Libraries.UpdateLibraryFile do
  @moduledoc """
  Input + metadata types for `update_library_file`. Generated — do not edit by hand.
  """

  defmodule Input do
    @moduledoc "Required arguments for `update_library_file`."
