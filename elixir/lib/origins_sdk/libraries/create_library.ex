defmodule OriginsSdk.Libraries.CreateLibrary do
  ...
  defmodule Input do
    ...
    defstruct [:adapter_config, :adapter_kind, :auto_ingest_videos, :auto_resync_enabled, :inherits_to_descendants, :name, :origin_entity_id, :transcribe_media]

    @doc false
    def to_json(%__MODULE__{} = input) do
      %{"adapter_config" => input.adapter_config, "adapter_kind" => input.adapter_kind, "auto_ingest_videos" => input.auto_ingest_videos, "auto_resync_enabled" => input.auto_resync_enabled, "inherits_to_descendants" => input.inherits_to_descendants, "name" => input.name, "origin_entity_id" => input.origin_entity_id, "transcribe_media" => input.transcribe_media}
    end
  end
