defmodule OriginsSdk.Podcasts.CreatePodcastConfig do
  @moduledoc """
  Input + metadata types for `create_podcast_config`. Generated — do not edit by hand.
  """

  defmodule Input do
    @moduledoc "Required arguments for `create_podcast_config`."
