defmodule OriginsSdk.Podcasts.UpdateYoutubeEpisode do
  @moduledoc """
  Input + metadata types for `update_youtube_episode`. Generated — do not edit by hand.
  """

  defmodule Input do
    @moduledoc "Required arguments for `update_youtube_episode`."
